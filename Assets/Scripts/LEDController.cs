...
public class LEDController : MonoBehaviour
{
    ...
    private short[] _nodes = {0,0,0,0,0};
    ...
    public void TurnOn()
    {
        ledMaterial.SetColor("_EmissionColor", onColor * 2f); // Multiply for intensity of green emissive color
    ...
    public void checkCircuit()
    {
        ...
        foreach (var node in _nodes) if (node == 0) circuitIsCorrect = false;
